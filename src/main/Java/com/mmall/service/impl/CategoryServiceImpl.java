...
public class CategoryServiceImpl implements ICategoryService{
    ...
    public ServerResponse updateCategoryName(Integer categoryId,String categoryName){
        if (categoryId == null || StringUtils.isBlank(categoryName)){
            return ServerResponse.createByErrorByMessage("更新商品类别参数错误");
        }
        ...
        return ServerResponse.createByErrorByMessage("更新商品品类失败");
    ...
    private Set<Category> findChildCategory(Set<Category> categorySet ,Integer categoryId){
        ...
        List<Category> categoryList = categoryMapper.selectCategoryChildByParentId(categoryId);
        //MyBatis没有查到，不会返回null对象；无需判空,否则要判空
