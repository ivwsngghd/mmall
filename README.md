# 项目相关
该项目用于本人学习分布式后台架构等相关技术知识。

# 项目介绍
该购物系统遵循分布式架构思想来进行开发，使用 Java 作为编程语言，使用 MySQL
作为数据库，Web 应用服务容器使用的是 tomcat8，使用了 Nginx 进行负载均衡和请求
分发，并且基于 Redis 提供的服务，实现了分布式集群的通讯同步功能以及高频访问信
息的缓存功能。可以满足高并发、强拓展性等市场需求。与基于普通的单体服务器开发
不同，它避免了许多缺点，譬如，耦合性高，因为拓展性不强导致硬件性能低下，更新
迭代需要停机维护影响运营等。该系统还能方便高效地利用着计算机云端相关技术，即
利用多个网络云服务器搭建自己的分布式线上生产环境。
